...
def evaluate_episode(
    ...
    for loaded in perception.prefetch(read_frame, df_manifest.itertuples()):
        ...
        quality_records.append({
            ...
            "sam2_cached_frames_consumed": perception.index + 1,
            "sam2_timing_scope": "cache_read_only_not_online_fps",
            "sam2_cache_receipt_sha256": perception.cached.receipt_sha256,
...
def build_recovery_decomposition(episode, intervals, events, errors_by_method,
    ...
    for interval in intervals:
        ...
        row = {
            ...
            "sam2_requested_count": int(bool(event and (event["sam2_called"] or event["sam2_cache_hit"]))),
            "sam2_inference_call_count": int(bool(event and event["sam2_called"])),
